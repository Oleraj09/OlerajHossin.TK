...
const inputh = document.querySelector("#html")
...
const inputc = document.querySelector("#css")
...
const inputj = document.querySelector("#js")
valuej.textContent = inputj.value
inputj.addEventListener("input", (event) => {
    valuej.textContent = event.target.value
})
const valuejq = document.querySelector("#valuejq")
const inputjq = document.querySelector("#jq")
valuejq.textContent = inputjq.value
inputjq.addEventListener("input", (event) => {
    valuejq.textContent = event.target.value
})
const valuep = document.querySelector("#valuep")
const inputp = document.querySelector("#php")
valuep.textContent = inputp.value
inputp.addEventListener("input", (event) => {
    valuep.textContent = event.target.value
})
const valuer = document.querySelector("#valuer")
const inputr = document.querySelector("#react")
